...
import { getBookedSeats, getUserSeats, bookSeat, cancelSeat } from "../utils/seatBooking";
...
const SeatSelection = () => {
  ...
  const handleBooking = () => {
    ...
    if (!success) {
      toast.error(`Seat ${selectedSeat} is already booked`);
      refreshSeats(user.email);
    ...
    navigate(`/passenger`, {
      state: { busId: id, seats: [selectedSeat] },
    });
  };
    ...
    <div className="p-6 max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-5 gap-3 mb-6">
        {seats.map((seat) => {
          ...
          else if (isBooked) style += "bg-gray-400 text-white cursor-not-allowed";
          ...
          return (
            <div
              ...
              className={style}
              title={
                isMine ? "Click to cancel booking" : isBooked ? "Already booked" : ""
              }
      ...
      <button
        ...
        className={`w-full py-2 rounded font-semibold transition
          ${selectedSeat ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-300 cursor-not-allowed"}
        `}
      >
        Book Seat
      </button>
